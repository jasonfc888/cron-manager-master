...
2. **用户ID (to)** - 从当前会话自动获取（如 `ou_c8f81e4319d585c18cbd2730c48ea4c4`）

**实现方式**：
- 从 `session_status` 命令输出中提取 `channel` 和 `user_id`
- 当前会话示例：`feishu:direct:ou_c8f81e4319d585c18cbd2730c48ea4c4`
...
4. 检查 `"to": "user:ou_c8f81e4319d585c18cbd2730c48ea4c4"`（格式正确）
...
- [ ] 包含用户ID → 检查 `"to": "user:ou_c8f81e4319d585c18cbd2730c48ea4c4"`（格式正确）
